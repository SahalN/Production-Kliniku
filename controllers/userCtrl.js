...
const getAllDoctorsController = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "Doctor Lists Fetched Succesfully ",
      data: doctors,
    });
  } catch (error) {
    console.log(error);
    res
      .status(500)
      .send({ success: false, error, message: "Error While Fetching Doctor" });
  }
};
...
const userAppointmentsController = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "User Appoinment Fetch Succesfully",
      data: appointments,
    });
  } catch (error) {
    console.log(error);
